 ...
 *
 */
int compare(int o1_departureTime, int o2_departureTime,int o1_departureTransportType, int o2_departureTransportType,int o1_departureMaxDuration, int o2_departureMaxDuration,int o1_departureTransportCompany, int o2_departureTransportCompany) {
      if (o1_departureTime - o2_departureTime < 0)
          return -1;
      else if (o1_departureTime - o2_departureTime < 0)
          return 1;
      else {
