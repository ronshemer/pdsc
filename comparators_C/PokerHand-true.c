...
int compare(int o1_indexOf[],int o2_indexOf[],int o1_charAt[],int o2_charAt[], int o1_countOccurrencesOf[],int o2_countOccurrencesOf[], int o1_lastIndexOf[],int o2_lastIndexOf[]) {
        ...
        if ((tripleCount1 > 1) || ((tripleCount1 == 1) && (o1_indexOf[2] != -1))) {      // c1 Full house
            if ((tripleCount2 > 1) || ((tripleCount2 == 1) && (o2_indexOf[2] != -1))) {  // c2 Full house too
                ...
                if (higherTriple == o2_lastIndexOf[3]) {
                    ...
                    while(i2 <= 12){
                        ...
                        if ((i2 != higherTriple) && ((o1_charAt[i2] == 2) || (o1_charAt[i2] == 3))) { // only c1 Full house
                            return -1;                                                
                        }
                        if ((i2 != higherTriple) && ((o2_charAt[i2] == 2) || (o2_charAt[i2] == 3))) { // only c2 Full house
                            return 1;
                        }
                    }
                }
        ...
        if ((tripleCount2 > 1) || ((tripleCount2 == 1) && (o2_indexOf[2] != -1))) {
            return -1;
        }
        return 0;
    }
