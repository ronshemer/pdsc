...
;relational Init/Pre
(rule (=> (and (= (rel2 o1 0) (rel2 o2 1)) (= (rel2 o2 0) (rel2 o1 1))

                (= (rel1 len1 0) (rel1 len2 1))
...
;relational Bad (property negation)
    (rule (=> (distinct (rel1 ret 0) (* -1 (rel1 ret 1))) (RelBad len1 len2 o1 o2 flag1 i ret exit)))
...
(declare-rel o1_0_eq_o2_1 (Int Int (Array Int Int) (Array Int Int) Bool Int Int Bool))
(rule (=> (= (rel2 o1 0) (rel2 o2 1)) (o1_0_eq_o2_1 len1 len2 o1 o2 flag1 i ret exit)))
...
(declare-rel len1_0_eq_len2_1 (Int Int (Array Int Int) (Array Int Int) Bool Int Int Bool))
(rule (=> (= (rel1 len1 0) (rel1 len2 1)) (len1_0_eq_len2_1 len1 len2 o1 o2 flag1 i ret exit)))
