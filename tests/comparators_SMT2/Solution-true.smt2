(set-info :original "Solution-true.pp.ll")
...
(rule (compare_1 0
           ...
           compare@%o1_getValue_0
           compare@%nondet_0))
(rule (let ((a!1 (= compare@%abscomp1.0_0
              (ite (> (- compare@%_call1_0 compare@%o1_getValue_0) (- 1))
                   (- compare@%_call1_0 compare@%o1_getValue_0)
                   (- 0 (- compare@%_call1_0 compare@%o1_getValue_0)))))
      (a!2 (= compare@%abscomp2.0_0
              (ite (> (- compare@%_call1_0 compare@%o2_getValue_0) (- 1))
                   (- compare@%_call1_0 compare@%o2_getValue_0)
                   (- 0 (- compare@%_call1_0 compare@%o2_getValue_0)))))
      (a!3 (=> (and compare@_12_0 compare@_1_0)
               (not (and (= compare@%o1_getValue_0 (- 1))
                         (= compare@%o2_getValue_0 (- 1))))))
      (a!4 (=> (and compare@_26_0 compare@_23_0)
               (not (> (- compare@%abscomp1.0_0 compare@%abscomp2.0_0) 0))))
      (a!5 (=> (and compare@_21_0 compare@_18_0)
...
(let ((a!8 (and (compare_1 0
                ...
                a!1
                a!2
                (=> compare@_12_0 (and compare@_12_0 compare@_1_0))
                a!3
                (=> compare@_14_0 (and compare@_14_0 compare@_12_0))
                (=> (and compare@_14_0 compare@_12_0)
                    (not (= compare@%o1_getValue_0 (- 1))))
                (=> compare@_16_0 (and compare@_16_0 compare@_14_0))
                (=> (and compare@_16_0 compare@_14_0)
                    (not (= compare@%o2_getValue_0 (- 1))))
                (=> compare@_23_0 (and compare@_23_0 compare@_16_0))
                (=> (and compare@_23_0 compare@_16_0)
                    (not (= compare@%abscomp1.0_0 compare@%abscomp2.0_0)))
                (=> compare@_26_0 (and compare@_26_0 compare@_23_0))
                a!4
                (=> compare@_18_0 (and compare@_18_0 compare@_16_0))
                (=> (and compare@_18_0 compare@_16_0)
                    (= compare@%abscomp1.0_0 compare@%abscomp2.0_0))
                (=> compare@_21_0 (and compare@_21_0 compare@_18_0))
                a!5
