(set-info :original "Match-true.pp.ll")
...
(rule (compare_1 0
           ...
           compare@%o1_score_0
           compare@%o2_score_0))
(rule (let ((a!1 (=> (and compare@_9_0 compare@_5_0)
               (not (< (+ compare@%o1_seq1start_0 compare@%o1_seq2start_0)
                       (+ compare@%o2_seq1start_0 compare@%o2_seq2start_0)))))
      (a!2 (= compare@%.0_1
              (ite (> (+ compare@%o1_seq1start_0 compare@%o1_seq2start_0)
                      (+ compare@%o2_seq1start_0 compare@%o2_seq2start_0))
                   1
                   0))))
(let ((a!3 (and (compare_1 0
                ...
                (=> compare@_.0_0
                    (or (and compare@_.0_0 compare@_9_0)
                ...
                a!2
                (=> (and compare@_5_0 |tuple(compare@_5_0, compare@_.0_0)|)
                    (< (+ compare@%o1_seq1start_0 compare@%o1_seq2start_0)
                       (+ compare@%o2_seq1start_0 compare@%o2_seq2start_0)))
                (= compare@%.0_2 (- 1))
                (=> (and compare@_3_0 |tuple(compare@_3_0, compare@_.0_0)|)
                ...
                (=> (and compare@_call_0
                    ...
                    (> compare@%o1_score_0 compare@%o2_score_0))
                (= compare@%.0_4 (- 1))
                (=> (and compare@_.0_0 compare@_9_0)
