(set-info :original "Word-true.pp.ll")
...
(declare-var compare@%_br10_0 Int )
...
(rule (let ((a!1 (and (compare_1 0
                           ...
                           compare@%o2_count_0)
                true
                (=> compare@_23_0 (and compare@_23_0 compare@_1_0))
                (=> (and compare@_23_0 compare@_1_0)
                    (not (= compare@%o1_count_0 compare@%o2_count_0)))
                (= compare@%_br10_0
                   (ite (> compare@%o1_count_0 compare@%o2_count_0) 1 (- 1)))
                (=> compare@_.0_0 (and compare@_.0_0 compare@_23_0))
                (= compare@%.0_1 compare@%_br10_0)
                (=> (and compare@_.0_0 compare@_23_0)
...
(rule (let ((a!1 (and (compare_1 1
                           ...
                           compare@%o2_count_0)
                true
                (=> compare@_8_0 (and compare@_8_0 compare@_i.0_0))
                (=> (and compare@_8_0 compare@_i.0_0)
                    (and (< compare@%i.0_0 compare@%o1_length_0)
                         (< compare@%i.0_0 compare@%o2_length_0)))
                (= compare@%_call2_0 (+ compare@%o1_0 (* compare@%i.0_0 4)))
                (=> compare@_8_0
                    (or (<= compare@%o1_0 0) (> compare@%_call2_0 0)))
                (=> compare@_8_0 (> compare@%o1_0 0))
                (=> compare@_8_0
                    (= compare@%_10_0
                       (select compare@%_call_0 compare@%_call2_0)))
                (= compare@%_call3_0 (+ compare@%o2_0 (* compare@%i.0_0 4)))
                (=> compare@_8_0
                    (or (<= compare@%o2_0 0) (> compare@%_call3_0 0)))
                (=> compare@_8_0 (> compare@%o2_0 0))
                (=> compare@_8_0
                    (= compare@%_12_0 (select compare@%_2_0 compare@%_call3_0)))
                (=> compare@_14_0 (and compare@_14_0 compare@_8_0))
                (=> (and compare@_14_0 compare@_8_0)
                    (not (< compare@%_10_0 compare@%_12_0)))
                (= compare@%_call5_0 (+ compare@%o1_0 (* compare@%i.0_0 4)))
                (=> compare@_14_0
                    (or (<= compare@%o1_0 0) (> compare@%_call5_0 0)))
                (=> compare@_14_0 (> compare@%o1_0 0))
                (=> compare@_14_0
                    (= compare@%_16_0
                       (select compare@%_call_0 compare@%_call5_0)))
                (= compare@%_call6_0 (+ compare@%o2_0 (* compare@%i.0_0 4)))
                (=> compare@_14_0
                    (or (<= compare@%o2_0 0) (> compare@%_call6_0 0)))
                (=> compare@_14_0 (> compare@%o2_0 0))
                (=> compare@_14_0
                    (= compare@%_18_0 (select compare@%_2_0 compare@%_call6_0)))
                (=> compare@_20_0 (and compare@_20_0 compare@_14_0))
                (=> (and compare@_20_0 compare@_14_0)
                    (not (> compare@%_16_0 compare@%_18_0)))
                (=> compare@_i.0_1 (and compare@_i.0_1 compare@_20_0))
                compare@_i.0_1
                (= compare@%i.0_1 (+ compare@%i.0_0 1))
                (=> (and compare@_i.0_1 compare@_20_0)
                    (= compare@%i.0_2 compare@%i.0_1)))))
  (=> a!1
      (compare_1 1
                 compare@%_call_0
                 ...
                 compare@%o1_count_0
                 compare@%o2_count_0))))
(rule (let ((a!1 (=> (and compare@.critedge_0 compare@_i.0_0)
               (not (and (< compare@%i.0_0 compare@%o1_length_0)
                         (< compare@%i.0_0 compare@%o2_length_0))))))
(let ((a!2 (and (compare_1 1
                ...
                true
                (=> compare@.critedge_0
                    (and compare@.critedge_0 compare@_i.0_0))
                a!1
                (=> compare@_8_0 (and compare@_8_0 compare@_i.0_0))
                (=> (and compare@_8_0 compare@_i.0_0)
                    (and (< compare@%i.0_0 compare@%o1_length_0)
                ...
                (=> compare@_.0_0
                    (or (and compare@_.0_0 compare@.critedge_0)
                        (and compare@_14_0
                             |tuple(compare@_14_0, compare@_.0_0)|)
                        (and compare@_8_0 |tuple(compare@_8_0, compare@_.0_0)|)))
                (= compare@%.0_1 (- compare@%o1_length_0 compare@%o2_length_0))
                (=> (and compare@_14_0 |tuple(compare@_14_0, compare@_.0_0)|)
                    (> compare@%_16_0 compare@%_18_0))
                (= compare@%.0_2 1)
                (=> (and compare@_8_0 |tuple(compare@_8_0, compare@_.0_0)|)
                    (< compare@%_10_0 compare@%_12_0))
                (= compare@%.0_3 (- 1))
                (=> (and compare@_.0_0 compare@.critedge_0)
