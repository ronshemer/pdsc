(set-info :original "NameComparator-true.pp.ll")
...
(rule (let ((a!1 (and (compare_1 0
                ...
                (=> (and compare@_i.0_0 compare@_1_0)
                    (not (= compare@%o1_Name_0 compare@%o2_Name_0)))
                (= compare@%i.0_1 0)
                (=> (and compare@_i.0_0 compare@_1_0)
...
(rule (=> (and (compare_1 0
         ...
         (=> (and compare@_.0_0 compare@_1_0)
             (= compare@%o1_Name_0 compare@%o2_Name_0))
         (= compare@%.0_1 0)
...
(rule (let ((a!1 (and (compare_1 1
                           ...
                           compare@%o1_Name_0)
                true
                (=> compare@_6_0 (and compare@_6_0 compare@_i.0_0))
                (=> (and compare@_6_0 compare@_i.0_0) (< compare@%i.0_0 3))
                (= compare@%_call2_0 (+ compare@%nondet_0 (* compare@%i.0_0 4)))
                (=> compare@_6_0
                    (or (<= compare@%nondet_0 0) (> compare@%_call2_0 0)))
                (=> compare@_6_0 (> compare@%nondet_0 0))
                (=> compare@_6_0
                    (= compare@%_call3_0
                       (select compare@%_call_0 compare@%_call2_0)))
                (=> compare@_10_0 (and compare@_10_0 compare@_6_0))
                (=> (and compare@_10_0 compare@_6_0)
                    (not (= compare@%_call3_0 compare@%o1_Name_0)))
                (=> compare@_12_0 (and compare@_12_0 compare@_10_0))
                (=> (and compare@_12_0 compare@_10_0)
                    (not (= compare@%_call3_0 compare@%o2_Name_0)))
                (=> compare@_i.0_1 (and compare@_i.0_1 compare@_12_0))
                compare@_i.0_1
                (= compare@%i.0_1 (+ compare@%i.0_0 1))
                (=> (and compare@_i.0_1 compare@_12_0)
                    (= compare@%i.0_2 compare@%i.0_1)))))
  (=> a!1
      (compare_1 1
                 compare@%_call_0
...
(rule (let ((a!1 (and (compare_1 1
                           ...
                           compare@%o1_Name_0)
                true
                (=> compare@_14_0 (and compare@_14_0 compare@_i.0_0))
                (=> (and compare@_14_0 compare@_i.0_0)
                    (not (< compare@%i.0_0 3)))
                (=> compare@_6_0 (and compare@_6_0 compare@_i.0_0))
                (=> (and compare@_6_0 compare@_i.0_0) (< compare@%i.0_0 3))
                (= compare@%_call2_0 (+ compare@%nondet_0 (* compare@%i.0_0 4)))
                ...
                (=> compare@_.0_0
                    (or (and compare@_.0_0 compare@_14_0)
                        (and compare@_10_0
                ...
                (=> (and compare@_10_0 |tuple(compare@_10_0, compare@_.0_0)|)
                    (= compare@%_call3_0 compare@%o2_Name_0))
                (= compare@%.0_2 (- 1))
                (=> (and compare@_6_0 |tuple(compare@_6_0, compare@_.0_0)|)
                    (= compare@%_call3_0 compare@%o1_Name_0))
                (= compare@%.0_3 1)
