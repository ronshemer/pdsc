(set-info :original "ArrayInt-false.pp.ll")
...
(declare-var |tuple(compare@_13_0, compare@.critedge_0)| Bool )
(declare-var |tuple(compare@_7_0, compare@.critedge_0)| Bool )
(declare-var |tuple(compare@_index.0_0, compare@.critedge_0)| Bool )
(declare-var compare@%.0_1 Int )
(declare-var compare@%.0_2 Int )
(declare-var compare@%.0_4 Int )
(declare-var compare@.critedge.split_0 Bool )
...
(rule (let ((a!1 (and (compare_1 1
  ...
  (=> a!1
      (compare_1 1
                 ...
                 compare@%o1_length_0
                 compare@%o2_length_0))))
(rule (let ((a!1 (=> (and compare@_index.0_0
                    |tuple(compare@_index.0_0, compare@.critedge_0)|)
...
(let ((a!2 (and (compare_1 1
                ...
                (=> (and compare@_13_0 compare@_7_0)
                    (not (< compare@%_call3_0 compare@%_call5_0)))
                (=> |tuple(compare@_13_0, compare@.critedge_0)| compare@_13_0)
                (=> |tuple(compare@_7_0, compare@.critedge_0)| compare@_7_0)
                (=> |tuple(compare@_index.0_0, compare@.critedge_0)|
                    compare@_index.0_0)
                (=> compare@.critedge_0
                    (or (and compare@_13_0
                             |tuple(compare@_13_0, compare@.critedge_0)|)
                        (and compare@_7_0
                             |tuple(compare@_7_0, compare@.critedge_0)|)
                        (and compare@_index.0_0
                             |tuple(compare@_index.0_0, compare@.critedge_0)|)))
                (=> (and compare@_13_0
                         |tuple(compare@_13_0, compare@.critedge_0)|)
                ...
                (=> compare@.critedge.split_0
                    (and compare@.critedge.split_0 compare@.critedge_0))
                compare@.critedge.split_0)))
  (=> a!2
      (compare_1 2
                 compare@%_2_0
