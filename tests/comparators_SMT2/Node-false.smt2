(set-info :original "Node-false.pp.ll")
...
(rule (let ((a!1 (and (compare_1 0
                ...
                (= compare@%_7_0 (select compare@%_3_0 compare@%_call4_0))
                ...
                (=> compare@_13_0
                    (= compare@%_call10_0
                       (select compare@%_4_0 compare@%_call9_0)))
                ...
                (=> compare@_.0_0
                    (or (and compare@_.0_0 compare@_19_0)
                        (and compare@_13_0
